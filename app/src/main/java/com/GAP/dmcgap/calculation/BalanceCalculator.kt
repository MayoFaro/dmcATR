...
data class DmcConfig(
    val baseMass: Double     = 13479.0,
    val baseArm:  Double     = 14.06,
        ...
        // ─── 1) Base + équipage ─────────────────────────────────────────────────────
                ...
                val dist = distributionOverride ?: run {
                    ...
                    optimizeDistribution(
                        ...
                        maxF1           = 750, maxF2 = 2000, maxF3 = 750,
                ...
                checkEnvelope(zfmCg, zfmMass, "ZFM")
                ...
                checkEnvelope(towCg, towMass, "TOW")
                ...
                checkEnvelope(ldwCg, ldwMass, "LDM")
